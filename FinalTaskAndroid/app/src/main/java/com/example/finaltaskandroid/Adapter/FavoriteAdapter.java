...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view->{
            ...
            toDetail.putExtra(MainActivity2.EXTRA_DATA, favorite);
            toDetail.putExtra(MainActivity2.EXTRA_TYPE, "FAVORITE");
            ((Activity) c).startActivityForResult(toDetail, MainActivity2.DETAIL_RESULT_CODE);
        });
    }
    ...
    public void addFavorite(List<Favorite> favorite) {
        this.favList.clear();
